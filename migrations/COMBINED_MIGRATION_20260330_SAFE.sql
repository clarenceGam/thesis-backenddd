-- ============================================================================
-- COMBINED MIGRATION FILE (SAFE VERSION - No Inventory Unit Change)
-- Date: March 30, 2026
-- Purpose: Consolidate all recent migrations - Skip problematic unit ENUM
-- ============================================================================
-- This version skips the inventory_items.unit ENUM change to avoid data issues
-- ============================================================================
...
-- 6.1 SKIPPED: inventory_items.unit ENUM change (causes data truncation with existing data)
-- Note: Keep existing unit column as-is to avoid breaking existing inventory data
...
-- MIGRATION COMPLETE
-- ============================================================================
-- All migrations successfully applied except inventory_items.unit ENUM change.
-- The unit column will remain as VARCHAR to preserve existing data.
-- New inventory_requests table uses VARCHAR for unit as well.
-- ============================================================================
